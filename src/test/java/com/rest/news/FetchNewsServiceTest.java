...
public class FetchNewsServiceTest {
    ...
    public void mockRestService(){
        ...
        FetchNewsService spy_service = Mockito.spy(FetchNewsService.class);
        Mockito.doReturn(news_response).when(spy_service).getResponse("https://newsapi.org/v2/top-headlines?country=in&apiKey=1e1541fe894d423ea58d74b9d519704c");

        assertEquals(news_response,spy_service.getTodaysNews("1e1541fe894d423ea58d74b9d519704c"));
